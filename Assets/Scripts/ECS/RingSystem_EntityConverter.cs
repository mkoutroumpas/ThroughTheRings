...
public class RingSystem_EntityConverter : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    {
        manager.AddComponent(entity, typeof(RingObject_Entity));
        ...
        RingObject_RotationSpeed rorationSpeed = new RingObject_RotationSpeed { Self = new Vector3(1f, 1f, 1f), System = new Vector3(1f, 1f, 1f) };
