...
public class RingSystem_EntitySpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _prefabIcoSpheres[0] = Resources.Load("IcoShpere_10000", typeof(GameObject)) as GameObject;
        _prefabIcoSpheres[1] = Resources.Load("IcoShpere_10000", typeof(GameObject)) as GameObject;
        _prefabIcoSpheres[2] = Resources.Load("IcoShpere_10000", typeof(GameObject)) as GameObject;
        _prefabIcoSpheres[3] = Resources.Load("IcoShpere_10000", typeof(GameObject)) as GameObject;
        _prefabIcoSpheres[4] = Resources.Load("IcoShpere_10000", typeof(GameObject)) as GameObject;
